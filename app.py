...
<div class="main-header">
    ...
    <p>Tác giả: Ma Công Yến - Trường Tiểu học Minh Quang - ĐT: 052 2700 999</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Công Yến - Trường Tiểu học Minh Quang - ĐT: 052 2700 999</div>", unsafe_allow_html=True)
